...
| customerId               | string                                                         | Microsoft 請求プラットフォームでの顧客の一意の識別子を取得または設定します。  |
...
| offerName                | string                                                         | プラン名を取得または設定します。                                          |
...
| currency                 | string                                                         | 価格に関連付けられている通貨を取得または設定します。                 |
| customerName             | string                                                         | 顧客名を取得または設定します。                                       |
| customerId               | string                                                         | 顧客の一意の識別子を取得または設定します。                          |
...
| region                   | string                                                         | リソースインスタンスに関連付けられている領域を取得または設定します。        |
...
| Quantity | INT | この行項目に関連付けられている単位の数を取得または設定します。 |
...
| AlternateId | string | 代替 ID (見積もり ID) を取得または設定します。 |
| PriceAdjustmentDescription | string | 価格調整の説明を取得または設定します。 |
| DiscountDetails | string |  **非推奨**です。 この購入に関連付けられている割引の詳細を取得または設定します。 |
...
| 発行元 | string | パブリッシャーの名前を取得します。値の設定もできます。 |
...
| MeterSubCategory | string | メーターサブカテゴリを取得または設定します。 |
...
| Quantity | decimal | 使用量を取得または設定します。 |
...
| BillingCurrency | string | メートルが顧客または請求通貨の現地通貨で請求される ISO 通貨を取得または設定します。 |
