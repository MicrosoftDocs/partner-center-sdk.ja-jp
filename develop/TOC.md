...
#### [パートナー センターのアプリの詳細を登録する](create-apps-for-partner-center-for-microsoft-national-clouds.md)
...
### [パートナー センター認証](partner-center-authentication.md)
...
#### [パートナー MPN ID で顧客のサブスクリプションを取得する](get-all-subscriptions-by-partner.md)
...
#### [ユーザー アカウントを ID で取得する](get-a-user-account-by-id.md)
...
#### [市場別の住所書式規則を取得する](get-market-specific-validation-data.md)
...
## [パートナー センターのマネージド API リファレンス](https://docs.microsoft.com/dotnet/api/?view=partnercenter-dotnet-latest)
